...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2021 a las 13:33:52
...
INSERT INTO `ciudades` (`id`, `ubicacionpaisid`, `estadonombre`) VALUES
(1, 3, 'Azerbaijan'),
...
--
-- Estructura de tabla para la tabla `colaboradorde`
--

CREATE TABLE `colaboradorde` (
  `id` int(11) NOT NULL,
  `tipo` int(11) DEFAULT NULL,
  `empleadoayudaa` int(11) DEFAULT NULL,
  `empleadocolaborado` int(11) DEFAULT NULL,
  `estatus` varchar(40) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `colaboradorde`
--

INSERT INTO `colaboradorde` (`id`, `tipo`, `empleadoayudaa`, `empleadocolaborado`, `estatus`) VALUES
(1, 2, 1, 3, ''),
(2, 2, 6, 4, 'Anulada');
...
INSERT INTO `empleados` (`id`, `identificacion`, `nombres`, `apellidos`, `direccion`, `telefono`, `idciudad`, `estatus`) VALUES
(1, 14986064, 'ALCIDES J', 'CADIZ G', 'SU CASA', '0416-5895525', 378, ''),
(2, 123456, 'fgnsfg', 'nsfgn', 'su casa', '+58 424-9243028', 703, 'Anulada'),
(3, 1489654, 'gerardo f', 'gamex z', 'su casa', '30040059', 689, 'Anulada'),
(4, 256845651, 'oscar j', 'cordero m', 'apartamento', '0416-48956332', 1848, ''),
(6, 5896522, 'andres d', 'cordero m', 'esquina', '0412-8962255', 676, ''),
(7, 1598647425, 'GABRIEL', 'CADIZ G', 'SU CASA', '0416-5895525', 688, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jefede`
--

CREATE TABLE `jefede` (
  `id` int(11) NOT NULL,
  `tipo` int(11) DEFAULT NULL,
  `empleadojefe` int(11) DEFAULT NULL,
  `empleadosupervisado` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `jefede`
--

INSERT INTO `jefede` (`id`, `tipo`, `empleadojefe`, `empleadosupervisado`) VALUES
(1, 1, 1, 6),
(3, 1, 6, 3),
(4, 1, 2, 4),
(5, 1, 1, 2);
...
INSERT INTO `organigrama` (`id`, `empleado`, `cargo`, `estatus`) VALUES
(7, 1, 1, ''),
(11, 3, 3, ''),
(12, 4, 3, ''),
(13, 2, 4, ''),
...
INSERT INTO `relacion` (`id`, `tipo`) VALUES
(1, 'Jefe'),
(2, 'Colaborador');
...
ALTER TABLE `ciudades`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ubicacionpaisid` (`ubicacionpaisid`);

--
-- Indices de la tabla `colaboradorde`
--
ALTER TABLE `colaboradorde`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tipo` (`tipo`),
  ADD KEY `empleadoayudaa` (`empleadoayudaa`),
  ADD KEY `empleadocolaborado` (`empleadocolaborado`);
...
--
-- Indices de la tabla `jefede`
--
ALTER TABLE `jefede`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tipo` (`tipo`),
  ADD KEY `empleadojefe` (`empleadojefe`),
  ADD KEY `empleadosupervisado` (`empleadosupervisado`);
...
--
-- AUTO_INCREMENT de la tabla `colaboradorde`
--
ALTER TABLE `colaboradorde`
...
--
-- AUTO_INCREMENT de la tabla `jefede`
--
ALTER TABLE `jefede`
...
--
ALTER TABLE `ciudades`
  ADD CONSTRAINT `ciudades_ibfk_1` FOREIGN KEY (`ubicacionpaisid`) REFERENCES `pais` (`id`);

--
-- Filtros para la tabla `colaboradorde`
--
ALTER TABLE `colaboradorde`
  ADD CONSTRAINT `colaboradorde_ibfk_1` FOREIGN KEY (`tipo`) REFERENCES `relacion` (`id`),
  ADD CONSTRAINT `colaboradorde_ibfk_2` FOREIGN KEY (`empleadoayudaa`) REFERENCES `empleados` (`id`),
  ADD CONSTRAINT `colaboradorde_ibfk_3` FOREIGN KEY (`empleadocolaborado`) REFERENCES `empleados` (`id`);

--
-- Filtros para la tabla `empleados`
--
ALTER TABLE `empleados`
  ADD CONSTRAINT `empleados_ibfk_1` FOREIGN KEY (`idciudad`) REFERENCES `ciudades` (`id`);

--
-- Filtros para la tabla `jefede`
--
ALTER TABLE `jefede`
  ADD CONSTRAINT `jefede_ibfk_1` FOREIGN KEY (`tipo`) REFERENCES `relacion` (`id`),
  ADD CONSTRAINT `jefede_ibfk_2` FOREIGN KEY (`empleadojefe`) REFERENCES `empleados` (`id`),
  ADD CONSTRAINT `jefede_ibfk_3` FOREIGN KEY (`empleadosupervisado`) REFERENCES `empleados` (`id`);

--
-- Filtros para la tabla `organigrama`
--
ALTER TABLE `organigrama`
  ADD CONSTRAINT `organigrama_ibfk_1` FOREIGN KEY (`empleado`) REFERENCES `empleados` (`id`),
  ADD CONSTRAINT `organigrama_ibfk_2` FOREIGN KEY (`cargo`) REFERENCES `cargos` (`id`);
COMMIT;
